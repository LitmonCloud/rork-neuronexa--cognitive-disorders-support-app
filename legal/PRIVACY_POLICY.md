...
- App version
- Unique device identifiers (for crash reporting only)

**Usage Data (When Analytics Enabled):**
...
- Notify you of new features (opt-in only)
...
When you enable cloud sync (future feature):
- Data is encrypted in transit using TLS 1.3
- Data is encrypted at rest using AES-256
- Stored on secure servers (Supabase)
...
**Current Providers:**
- **Rork Toolkit SDK:** AI-powered features (task breakdowns, coaching)
- **Apple/Google:** Payment processing for in-app purchases

**Future Providers (When Features Launch):**
- **Supabase:** Cloud database and authentication
- **PostHog:** Privacy-focused analytics (opt-in)
- **Sentry:** Error tracking and crash reporting
- **Resend/SendGrid:** Email delivery for caregiver alerts
...
- Tap "Delete My Data" to remove all local data
- Tap "Delete Analytics Data" to clear usage data
...
When disabled, we will not collect any usage data or analytics events.
...
- Opt-out of the sale of your information (we do not sell)
...
**Local Data:** Retained until you delete the app or manually delete data.

**Cloud Data (Future):** Retained until you delete your account or request deletion.

**Analytics Data:** Retained for 90 days, then anonymized or deleted.
